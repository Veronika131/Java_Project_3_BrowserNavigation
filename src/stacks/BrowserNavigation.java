...
public class BrowserNavigation 
{
	...
	public static void main(String[] args) 
	{
		...
		// NOTE: An example of testing the boundary condition when forward links stack is empty
        //final String FILENAME = "resources/links2.txt";

        // NOTE: An example of testing the boundary condition when both stacks are empty
        //final String FILENAME = "resources/links3.txt";

        // NOTE: An example of testing the boundary condition going back and forth repeatedly
        //final String FILENAME = "resources/links4.txt";
